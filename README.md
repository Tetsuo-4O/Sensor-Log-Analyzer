...
-> ./sensorlog
  ...
  Selecting option 3/TRIP report will generate a kml file in the common directory. Drag-and-drop this kml file into a Google Earth window or the Google Earth Pro desktop app to generate a VISUAL flight path on the map, complete with coordinate-based event markers. 
